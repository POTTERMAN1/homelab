...
While GitOps and Infrastructure as Code (IaC) ensure that the _configuration_ of the homelab can be rebuilt from scratch at any time, persistent data (like databases, user uploads, and logs) requires dedicated storage protection.
...
_Note: Off-site data replication (e.g., S3 cloud backups) is slated for a future roadmap phase._

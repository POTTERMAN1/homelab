...
```caddyfile
--8<-- "ansible/roles/caddy/templates/Caddyfile.j2"
```

**[View the Caddy Ansible Role on GitHub](https://github.com/potterman1/homelab/tree/main/ansible/roles/caddy)**
...
- **IONOS VPS (`ionos_vps`):** hoodik cloud storage
